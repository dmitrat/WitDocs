...
```xml
<ProjectReference Include="path/to/OutWit.Docs.Framework.csproj" />
```
...
@* Pages/Index.razor *@
@page "/"
@using OutWit.Docs.Framework.Components.Pages
...
On Release build, the framework automatically runs the [OutWit.Docs.Generator](../OutWit.Docs.Generator/) tool to generate:
...
witdocs-generate --site ./MySite --url https://example.com --hosting cloudflare
```
...
witdocs-generate --site ./MySite --og-images
```

See [OutWit.Docs.Generator](../OutWit.Docs.Generator/) for the full CLI option list.
